...
public class JavaCV1 {	
	...
	public static void main(String[] args) throws Exception {
		...
		cPane.setBackground(new Color(51, 51, 51));
		...
		leftPane.setBackground(new Color(51, 51, 51));
		...
		JLabel markerImgLabel = new JLabel(new ImageIcon(marker));
		
		// credits
		JLabel creditsLabel = new JLabel("Credits");
		creditsLabel.setFont(new Font("Segoe UI", Font.PLAIN, 18));
		JLabel credits1 = new JLabel("Made with Java and OpenCV");
		JLabel credits2 = new JLabel("Created by:");
		JLabel credits3 = new JLabel("    William Yen");
		JLabel credits4 = new JLabel("    Ishan Sethi");
		JLabel credits5 = new JLabel("    Riley Wong");
		JLabel credits6 = new JLabel("Hack@CEWIT 2017");
		credits6.setFont(new Font("Segoe UI", Font.PLAIN, 18));
		
		JPanel rightPane = new JPanel();
		rightPane.setLayout(new BoxLayout(rightPane, BoxLayout.Y_AXIS));
		rightPane.setPreferredSize(new Dimension(WINDOW_W - WIDTH - (PADDING * 6), WINDOW_H - (PADDING * 6)));
		rightPane.setBackground(new Color(51, 51, 51));
		...
		container.getContentPane().setBackground(new Color(51, 51, 51));
